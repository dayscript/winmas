    ...
    <div class="container-fluid">
        <header>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm text-center hero-razones">
                        <img src="img/razones.png">
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="container">
            <div class="row intro-infografia">
                <div class="col-sm pt-5 pr-5 pb-5 pl-5 text-center">
                    ...
                    <h2 class="mt-5 mb-5">Esta infografía tiene<br> las respuestas que buscas</h2>
                    <img src="img/infografia-winsportsmas.jpg" class="infografia">
                </div>
            </div>
        </div>
        <div class="container cta-section">
            <div class="row">
                <div class="col-sm text-center">
                    <a href="#" class="cta font-source openBtn" data-toggle="modal" data-target="#modalInfografia">Ver video</a>
                </div>
            </div>
        </div>
        <!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <iframe width="100%" height="480" src="//mdstrm.com/embed/5e00d0d1f6002f0881f86a68" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
